...
the pandas DataFrame to use (data=____), and the type of plot (kind="count").
...
the name of the quantitative variable to summarize on the y-axis (y=____), the pandas DataFrame to use (data=____), and the type of categorical plot (kind="bar").
...
"<2 hours", "2 to 5 hours", "5 to 10 hours", or ">10 hours". 
...
In an earlier exercise, we explored the relationship between studying and final grade by using a bar plot 
...
As a reminder, to create a box plot you'll need to use the catplot() function and specify the name of the categorical variable to put on the x-axis (x=____), 
the name of the quantitative variable to summarize on the y-axis (y=____), the pandas DataFrame to use (data=____), and the type of plot (kind="box").
...
Possible Answers
    ...
    The median grade among students studying less than 2 hours is 10.0. (Answer)
"""
...
Seaborn has already been imported as sns and matplotlib.pyplot has been imported as plt. 
...
we'll continue to use the student_data dataset to compare the distribution of final grades ("G3") between students who are in a romantic relationship and those that are not. 
...
this time using a point plot to answer the question: 
...
As a reminder, to create a point plot, 
use the catplot() function and specify the name of the categorical variable to put on the x-axis (x=____), 
the name of the quantitative variable to summarize on the y-axis (y=____), the pandas DataFrame to use (data=____), and the type of categorical plot (kind="point").
