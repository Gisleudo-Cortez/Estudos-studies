...
Let's begin exploring the NSFG data! It has been pre-loaded for you into a DataFrame called nsfg.
"""
...
They quickly give you an overview of the distribution of a variable, that is, what values the variable can have, and how many times each value appears.
...
You'll use the bins parameter that you saw in the video, and also a new parameter - histtype - which you can read more about here in the matplotlib documentation. 
Learning how to read documentation is an essential skill. 
If you want to learn more about matplotlib, you can check out DataCamp's Introduction to Data Visualization with Matplotlib course.
"""
...
### https://github.com/AllenDowney/empiricaldist ### functions for Pmf and Cdf ect.